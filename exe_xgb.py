...
# Load the dataset
a1 = pd.read_excel("/Users/saurabhkumar/Documents/credit_Modelling_project/case_study1.xlsx")
a2 = pd.read_excel("/Users/saurabhkumar/Documents/credit_Modelling_project/case_study2.xlsx")
...
a3=pd.read_excel("/Users/saurabhkumar/Documents/credit_Modelling_project/Material_Session 04/Unseen_Dataset.xlsx")
cols_in_df=list(df.column)
cols_in_df.pop(42)
...
a3.to_excel("/Users/saurabhkumar/Documents/credit_Modelling_project/Final_prediction.xlsx",index=False)


#print runtime 
end_time=time.time()
elapsed_time=end_time-start_time
print("total run time of this program- "+str(round(elapsed_time,2))+' sec')
